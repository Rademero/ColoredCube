/* ===================================================================== */
/* Attach this script to the camera that you are using for rotation      */
/* around an object. The lookAt variable is the object you want to       */
/* rotate around, and lookAT is set in the attributs of the camera.      */
/* ===================================================================== */
...
public class CameraMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Allows the cammera to freely rotate around the lookAt object.
        cameraX = Mathf.Repeat(cameraX, 360f);
